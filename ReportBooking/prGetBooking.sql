...
--33 Potwierdzenie bookingu (link)
	...
	-- ,tSBConfirmation.BookingNumber AS [BookingConfirmationLink]
	-- ,tSBConfirmation.ShippingBookingId AS [BookingConfirmationId]

	,tSBConfirmation.ActionNumber AS [BookingConfirmationLink]
	,tSBConfirmation.ShippingActionMainDataId AS [BookingConfirmationId]
	
	-- ,tSBConfirmation.BookingMainId AS [BookingConfirmationLink]
	-- ,tSBConfirmationMD.ActionNumber AS [BookingConfirmationId]
--34 CUT OFF CARGO CY
...
FROM
	...
	ON tSA.ShippingActionMainDataId = tSBConfirmation.ShippingActionMainDataId
