...
,tSCargo.GrossWeight gw
 ,tGrossWeightUnitName.Name wu 
,tSCargo.VolumeOfCargo vu
 ,tVolumeOfCargoUnitName.Name cun
...
WHERE tSOMD.OperationTypeId = @intLCLTypeDictId AND tSO.IsActive = 1
	...
	AND tSOMD.RelationTypeId=673
--AND tSOMD.OperationNumber LIKE '%000043%'


ORDER BY [W/M] DESC, DateOfReadiness DESC
